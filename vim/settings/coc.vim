...
autocmd BufEnter *.tsx,*.js,*.ts,*.css,*.scss,*.less,*.json,*.go call execute('CocEnable')
autocmd BufEnter *.tsx,*.js,*.ts,*.css,*.scss,*.less,*.json,*.go let g:asyncomplete_auto_completeopt = 0
autocmd BufEnter *.tsx,*.js,*.ts,*.css,*.scss,*.less,*.json,*.go let g:asyncomplete_auto_popup = 0
...
autocmd FileType typescriptreact,javascript,typescript,typescript.tsx,css,scss,less,json,go map <silent> <leader>qo :CocListResume<cr>
autocmd FileType typescriptreact,javascript,typescript,typescript.tsx,css,scss,less,json,go map <silent> <leader>qc :CocListCancel<cr>
...
autocmd FileType typescriptreact,javascript,typescript,typescript.tsx,css,scss,less,json,go map <silent> <leader>qp :CocPrev<cr>
autocmd FileType typescriptreact,javascript,typescript,typescript.tsx,css,scss,less,json,go map <silent> <leader>qn :CocNext<cr>
