...
```bash
sh -c "`curl -fsSL https://raw.githubusercontent.com/ofer987/dotfiles/master/install.sh`"
```
...
```bash
sh -c "`curl -fsSL https://raw.githubusercontent.com/ofer987/dotfiles/master/install.sh`" -s ask
```
